...
public class ClientePJ implements Serializable {
	...
	public String toString() {
		return "ClientePJ [id=" + id + ", cnpj=" + cnpj + ", nome=" + nome + ", ie=" + ie + ", im=" + im + ", fone="
				+ fone + ", celular=" + celular + ", cep=" + cep + ", rua=" + rua + ", nr=" + nr + ", compl=" + compl
				+ ", bairro=" + bairro + ", cidade=" + cidade + ", estado=" + estado + ", dtfund=" + dtfund
				+ ", responsavel=" + responsavel + ", email=" + email + ", facebook=" + facebook + ", site=" + site
				+ ", mark=" + mark + ", obs=" + obs + ", foto1=" + foto1 + ", foto2=" + foto2 + ", foto3=" + foto3
				+ ", foto4=" + foto4 + ", foto5=" + foto5 + ", dtcad=" + dtcad + "]";
	}
